...
class PriceGBPScreen extends React.Component {
    state = {
        data: [],
        isLoading: true,
        refreshing: false,
    ...
    handleButtonOnPress = (name, fullName, icon) => {
        ...
        Data.icon = icon;
        this.props.navigation.navigate('CryptoDetailsGBP')
    }
            ...
            <>
                ...
                {this.state.data.map(crypto => (
                    <Item
                        ...
                        price={crypto.DISPLAY.GBP.PRICE}
                    />
                ))}
            </ScrollView>
            </>
