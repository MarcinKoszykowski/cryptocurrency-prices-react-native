...
class CryptoDetailsEUR extends React.Component {
    state = {
        data: [],
        isLoading: true,
        refreshing: false,
    ...
    getData = () => {
        fetch(Url.fullCryptoData(Data.name, 'EUR'), {
            method: 'GET',
            headers: {
        ...
        .then(responseJSON => {
            this.setState({data : responseJSON.DISPLAY[Data.name].EUR})
...
export default CryptoDetailsEUR;