...
class CryptoDetailsGBP extends React.Component {
    state = {
        data: [],
        isLoading: true,
        refreshing: false,
    ...
    getData = () => {
        fetch(Url.fullCryptoData(Data.name, 'GBP'), {
            method: 'GET',
            headers: {
        ...
        .then(responseJSON => {
            this.setState({data : responseJSON.DISPLAY[Data.name].GBP})
...
export default CryptoDetailsGBP;